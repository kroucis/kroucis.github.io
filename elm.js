...
var $author$project$Me$name = 'Kyle Roucis';
var $author$project$Main$pageTitle = function (route) {
	switch (route.$) {
		case 'Home':
			return $author$project$Me$name;
		case 'ProjectDetail':
			var slug = route.a;
			return A2(
				$elm$core$Maybe$withDefault,
				...
				A2(
					$elm$core$Maybe$map,
					function (p) {
						return p.title + (' — ' + $author$project$Me$name);
					},
					$elm$core$List$head(
						A2(
		...
		case 'BlogList':
			return 'Writing — ' + $author$project$Me$name;
		case 'BlogPost':
			var slug = route.a;
			return A2(
				$elm$core$Maybe$withDefault,
		...
		default:
			return 'Not Found — ' + $author$project$Me$name;
	}
};
...
var $author$project$Main$viewFooter = A2(
	...
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					$elm$html$Html$Attributes$href('https://claude.ai/'),
					$elm$html$Html$Attributes$target('_blank'),
					$elm$html$Html$Attributes$rel('noopener noreferrer')
				]),
			_List_fromArray(
				[
					$elm$html$Html$text('Claude.ai')
				])),
			$elm$html$Html$text(' Sonnet 4.6.')
		]));
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text($author$project$Me$name)
					])),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
...
var $author$project$Me$bio = 'Software engineer. Functional programming enthusiast. I build things that are correct by construction.';
var $elm$html$Html$button = _VirtualDom_node('button');
var $elm$html$Html$img = _VirtualDom_node('img');
var $author$project$Me$links = _List_fromArray(
	[
			...
			[
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$Attributes$src($author$project$Me$photo),
						$elm$html$Html$Attributes$alt('Photo of ' + $author$project$Me$name)
					]),
				...
				_List_fromArray(
					[
						$elm$html$Html$text($author$project$Me$bio)
					])),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('project-card-image'),
								$elm$html$Html$Attributes$src(project.image),
								$elm$html$Html$Attributes$alt(project.title + ' screenshot')
							]),
						_List_Nil) : $elm$html$Html$text('')
					])),
				A2(
